        ...
        function($scope, $rootScope, $http, $routeParams, $location, $timeout, productService, categoryService, utility, $analytics) {            
            ...
            $scope.setSearchCategoryProducts = function(data, products) {
                ...
                try{
                    ...
                    clevertap.event.push("Category Interaction", {
                                ...
                                "Category Name": $scope.productCategoryName //$scope.categoryName
            ...
            $scope.checkout = function(flag) {
                ...
                try{ 
                    ...
                    console.log("Proceed to Checkout 111" + $scope.cartDetails.coupon_code);
                        ...
                        if(data.flag == 1) {
                            ...
                            try{  
                                ...
                                clevertap.event.push("Coupon", {
                                    ...
                                    "Subtotal" : parseFloat(gdTotal).toFixed(2),
                                    "Quantity" : $scope.cartItemCount,
                                    "Applied" : "Applied"
                                });
                                console.log("Apply Coupon" + $scope.cartDetails.grand_total);   
